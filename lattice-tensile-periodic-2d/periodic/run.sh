#!/bin/bash
# Reproduce: 2D direct tensile lattice, doubly-periodic mesh.
...
set ylabel 'Load [kN]'
set title '2D direct tensile lattice - periodic mesh'
set grid
plot 'ld.dat' using ($1*1000):($2/1000.) with linespoints lw 2 pt 7 ps 0.4 title 'periodic'
EOF
