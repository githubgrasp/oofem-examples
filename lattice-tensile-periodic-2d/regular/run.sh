#!/bin/bash
# Reproduce: 2D direct tensile lattice, non-periodic (regular) mesh.
# Blog: https://petergrassl.com/blog/lattice-tensile-periodic-2d/
#
...
set ylabel 'Load [kN]'
set title '2D direct tensile lattice - regular mesh'
set grid
plot 'ld.dat' using ($1*1000):($2/1000.) with linespoints lw 2 pt 7 ps 0.4 title 'regular'
EOF
