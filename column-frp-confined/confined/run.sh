#!/bin/bash
# Reproduce: CFRP-confined concrete cylinder (100 mm diameter × 200 mm tall,
# matching the unconfined case), axial compression. The CFRP wrap is
# discretised as truss hoops that only carry circumferential force.
#
# Pipeline:
